  ...
  <div class="w-full overflow-hidden rounded-lg shadow-xs">
    <div class="w-full px-5 overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        <thead>
          <tr
            class="text-xs font-semibold tracking-wide text-left text-black uppercase border-b dark:border-gray-700 bg-gray-700 dark:text-gray-400 dark:bg-gray-800"
          >
    ...
    <div
      class="px-5 grid py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800"
    >
