<template>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    "
                  >
                    <p class="small mb-0">Are you satisfied with this answer?  <span><button>✔</button></span>   <span><button @click="sendQuestion()" class="text-danger">✖</button></span>   </p>
                  </div>
                </div>
  ...
  export default {
    ...
    setup() {
      ...
      return { messages, sendMessage, messageContent, loading, sendQuestion };
    },
  };
  </script>
